    ...
    <div class="wrapper">
      ...
      <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
          后台模版<a href="https://github.com/almasaeed2010/AdminLTE">AdminLTE</a>
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; 2011-{{ date('Y') }} <a href="{{ Cache::get('system_author_website', 'http://douyasi.com') }}">{{ Cache::get('system_author','魔法师') }}</a></strong>  博客内容管理框架(<code>FansHub</code>)
      </footer>
